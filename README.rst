...
.. code-block:: shell
    ...
    pip3 install git+https://github.com/szelenka/Adafruit_MicroPython_LED_Animation.git

To install system-wide (this may be required in some cases):

.. code-block:: shell

    sudo pip3 install git+https://github.com/szelenka/Adafruit_MicroPython_LED_Animation.git
...
.. code-block:: python
    ...
    # Change board.NEOPIXEL to match the pin to which the NeoPixels are attached.
